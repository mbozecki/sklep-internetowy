...
<div class="sm:flex">
        ...
        <div class="flex-1 mt-16 sm:mt-56 sm:ml-24 sm:pr-32 text-center sm:text-left">
            ...
            <a href="sklep.html"><button id="btn-zapisz" class="mt-16 pt-2 pb-2 px-12 text-center ">Sprawdź <span class="ml-2 text-xs"><FontAwesomeIcon icon={faChevronDown}/></span> </button></a>
